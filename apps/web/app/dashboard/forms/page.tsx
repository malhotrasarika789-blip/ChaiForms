...
className="flex items-center gap-2 text-slate-400 hover:text-white mb-5"
...
className="rounded-xl bg-indigo-600 px-5 py-3 hover:bg-indigo-500"
...
className="p-3 rounded-xl bg-white/10 hover:bg-indigo-600"
