      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center justify-between px-6 lg:px-12">
        ...
        >
          ...
          <p className="mt-6 max-w-xl text-lg text-slate-400">
            ...
            Build modern forms, collect responses, view analytics,
            customize themes and share them with anyone.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-2xl shadow-[0_0_60px_rgba(79,70,229,.25)]">
            ...
            <form className="mt-6 space-y-3">
              <div>
                ...
                <input type="text" placeholder="Enter your name" value={form.fullName} onChange={(e) => setForm({
                  ...form,
              ...
              <div>
                ...
                <input type="email" placeholder="Enter your email" value={form.email} onChange={(e) => setForm({
                  ...form,
              ...
              <div>
                ...
                <input type="password" placeholder="Create password" value={form.password} onChange={(e) => setForm({
                  ...form,
            ...
            className="mt-3 h-10 w-full rounded-xl bg-indigo-600 font-semibold hover:bg-indigo-500">
              Create Account
              </button>
              </form>
